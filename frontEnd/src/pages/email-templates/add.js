...
const EmailTemplatesAdd = () => {
    ...
    let handleSubmit = async (e) => {
        ...
        if (form.checkValidity() === false || content === '') {
            ...
            return PostApiDetails(data, "email-templates")
                .then((resp) => {
    ...
    return (
        <>
            <Head>
                <title>Add | Email Templates | Limitless</title>
            </Head>
            <PermissionHelper Permissionname="add-emailtemplates" errorpage={<ErrorPage />}>
